...
// use treasury::contract::{execute, instantiate, query};
...
fn init_contracts(app: &mut App) -> (Addr, Addr, Addr, InstantiateMsg) {
    ...
    let treasury_instantiate_msg = white_whale::treasury::msg::InstantiateMsg {};
    ...
    let memory_instantiate_msg = white_whale::memory::msg::InstantiateMsg {};
...
fn test_update_config() {
    ...
    let err = app
        .execute_contract(
            ...
            &white_whale::tokenomics::lp_emissions::ExecuteMsg::UpdateConfig {
